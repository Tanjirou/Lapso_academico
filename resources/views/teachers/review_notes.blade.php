                            ...
                            <table id="column-filter" class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center"><button class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#modalNota"> Corregir </button></td>
                                        <!--Modal Carga de Nota-->
                                        <div class="modal fade" id="modalNota" tabindex="-1" role="dialog">
                                            <div class="modal-dialog modal-md" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title" id="exampleModalLabel">Correción de Nota del Corte</h5>
