                ...
                <ul class="list-unstyled menu-categories mt-0" id="accordionExample">
                    ...
                    @if (auth()->user()->user_type == 2)
                        ...
                        <!--GESTION SECCIONES-->
                            ...
                            <!--GESTION RECURSOS-->
                            <li class="menu">
                                <a href="#recurso" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                    <div class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                                        <span>Gestión Recursos</span>
                                    </div>
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <ul class="collapse submenu list-unstyled" id="recurso" data-parent="#accordionExample">
                                    <li class="active">
                                        <a href="{{ route('department-resources.index') }}">Crear</a>
                                    </li>
                                </ul>
                            </li>
                     ...
                     <!--GESTION DEPARTAMENTO-->
                        ...
                        <li class="menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="admin-pensum" data-parent="#accordionExample">
                                ...
                                <li class="active">
                                    <a href="{{route('subjects.index')}}">Crear Asignatura</a>
                                </li>
                                <li class="active">
                                    <a href="{{ route('mentions.index') }}">Carga de Asignaturas</a>
                                </li>
                                {{-- <li class="active">
                        ...
                        <li class="menu">
                            ...
                            <li class="active">
                                ...
                                <li class="active">
                                    <a href="{{ route('administrator.users_restore') }}">Restablecer Autent.</a>
                                </li>
                            </ul>
                        </li>
