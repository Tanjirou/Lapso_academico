            ...
            <div class="layout-px-spacing">
                <div class="mb-0">
                            ...
                            <nav class="breadcrumb-two align-self-center" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page"><a
                                            href="javascript:void(0);">Pensum</a></li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <h2 class="text-bold text-primary fond-bold m-0 mb-2">PENSA ACADÉMICOS</h2>
                    </div>
                                    ...
                                    <tbody>
                                        @forelse ($pensums as $pensum)
                                            <tr>
                                                ...
                                                <td>
                                                    <button wire:click="edit({{ $pensum->id }})" type="button"
                                                        class="bg-info px-2 py-1 text-white rounded">Editar</button>
                                                    <button wire:click="delete({{ $pensum->id }})" type="button"
