                                ...
                                <form method="POST" action="{{ route('administrator.users_create_store') }}">
                                    ...
                                    <div class="form-group">
                                        <label for="user_types" class="text-dark">{{ __('Tipo de Usuario') }}</label>
                                            <select wire:model="selectedUser" class="custom-select bg-white form-control border-primary @error('user_types') is-invalid @enderror" name="user_types" id="user_types">
                                    ...
                                    <div wire:target="selectedUser">
                                        @if($selectedUser!=1 && !empty($selectedUser) && !is_null($selectedUser))

                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="departments" class="text-dark">{{ __('Departamento') }}</label>
                                                        <select class="custom-select bg-white form-control @error('departments') is-invalid @enderror" name="departments" id="departments">
                                                            <option value="" >Seleccione</option>
                                        ...
                                        <div class="form-group">
                                            <label for="college_degree" class="text-dark">{{ __('Titulo de Grado/Especialidad') }}</label>
                                                <input id="college_degree" type="text" class="form-control mb-4 @error('college_degree') is-invalid @enderror" name="college_degree" value="{{ old('college_degree') }}" required autocomplete="college_degree" autofocus pattern="[a-zA-Z ]{2,48}" title="Solo se permiten letras" placeholder="Licenciado en Física">
