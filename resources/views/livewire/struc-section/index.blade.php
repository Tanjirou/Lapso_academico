                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <small id="sh-text1" class="form-text text-muted">Número de secciones a aperturar.</small>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input wire:model="struc_section.number_section"
                                                            class="form-control" type="number" placeholder="Ejemplo: 25">
                                                        <small id="sh-text1" class="form-text text-muted">Cantidad de estudiantes en promedio por sección para la planificación del próximo semestre.</small>
